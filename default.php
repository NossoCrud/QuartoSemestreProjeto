   ...
   <div class="topo"><!--Div para acomodar a parte de cadastro -->
       ...
       <form id="cadastroForm" action="cadastro.php" method="post"><!--Quando clicar em submit, vai mandar os dados do formulário para a página cadastro.php-->
          ...
          <table id="cadastrar">
           ...
           <tbody>
             ...
             <td id="largura1"> <input id="espaco1" type="text" name="nome" maxlength="100"placeholder="Informe o nome completo" required> </td>
             <td id="largura2"> <input id="espaco2" type="email" name="email" maxlength="100"placeholder="Informe o e-mail "required>  </td>
    ...
    <div class="listagem"><!--Div para acomodar a parte de edição, exclusão e listagem -->
     ...
     <script>
        ...
        }//fim da função de valida formato dos campos do cadastro
